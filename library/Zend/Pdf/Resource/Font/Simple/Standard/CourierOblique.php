 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_pdf_resource_font_simple_standard_courier_Oblique extends Zend_Pdf_Resource_Font_Simple_Standard
{
    /**** Public Interface ****/
    /* Object Lifecycle */
    /**
    ...
    public function __construct()
    {
        ...
        $this->_font_names[Zend_Pdf_Font::NAME_ID]['en'] = "\x004\x003\x000\x005\x001";
        $this->_font_names[Zend_Pdf_Font::NAME_FULL]['en'] = "\x00C\x00o\x00u\x00r\x00i\x00e\x00r\x00-\x00" . "O\x00b\x00l\x00i\x00q\x00u\x00e\x00 \x00" . "M\x00e\x00d\x00i\x00u\x00m";
        $this->_font_names[Zend_Pdf_Font::NAME_VERSION]['en'] = "\x000\x000\x003\x00.\x000\x000\x000";
        $this->_font_names[Zend_Pdf_Font::NAME_POSTSCRIPT]['en'] = "\x00C\x00o\x00u\x00r\x00i\x00e\x00r\x00-\x00" . "O\x00b\x00l\x00i\x00q\x00u\x00e";
        $this->_is_bold = false;
         ...
         */
        $this->_resource->base_font = new Zend_Pdf_Element_Name('Courier-Oblique');
    }
}