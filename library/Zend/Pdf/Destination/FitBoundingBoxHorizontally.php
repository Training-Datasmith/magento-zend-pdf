 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_pdf_destination_fit_Bounding_Box_Horizontally extends Zend_Pdf_Destination_Explicit
{
    /**
     ...
     */
    public static function create($page, $top): \Zend_pdf_destination_fit_Bounding_Box_Horizontally
    {
        ...
        $destination_array->items[] = new Zend_Pdf_Element_Name('FitBH');
        $destination_array->items[] = new Zend_Pdf_Element_Numeric($top);
        return new Zend_pdf_destination_fit_Bounding_Box_Horizontally($destination_array);
    }
    /**
    ...
    {
        $this->_destination_array->items[2] = new Zend_Pdf_Element_Numeric($top);
        return $this;
    }
}