 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_pdf_destination_fit_Bounding_Box_Vertically extends Zend_Pdf_Destination_Explicit
{
    /**
     ...
     */
    public static function create($page, $left): \Zend_pdf_destination_fit_Bounding_Box_Vertically
    {
        ...
        $destination_array->items[] = new Zend_Pdf_Element_Name('FitBV');
        $destination_array->items[] = new Zend_Pdf_Element_Numeric($left);
        return new Zend_pdf_destination_fit_Bounding_Box_Vertically($destination_array);
    }
    /**
